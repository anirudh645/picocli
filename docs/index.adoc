...
image::https://github.blog/wp-content/uploads/2008/12/forkme_right_red_aa0000.png[Fork me on GitHub,float="right"]
++++
...
Picocli-based applications can be ahead-of-time compiled to a image:https://www.graalvm.org/resources/img/brand-guidelines/downloads/GraalVM-logo.svg[GraalVM]
...
----
@Grab('info.picocli:picocli-groovy:4.7.8-SNAPSHOT')
import picocli.CommandLine
...
dependencies {
    // ...
    kapt 'info.picocli:picocli-codegen:4.7.8-SNAPSHOT'
}
```
...
[source,bash]
----
java -cp "picocli-4.7.8-SNAPSHOT.jar:checksum.jar" CheckSum --algorithm SHA-1 hello.txt
----
...
[source,bash]
----
java -cp "picocli-4.7.8-SNAPSHOT.jar;myapp.jar" org.myorg.GreetingApp Sarah Lea
----
...
[source,bash]
----
java -cp "picocli-4.7.8-SNAPSHOT.jar;myapp.jar" org.myorg.GreetingApp --locale=es Sarah Lea
----
...
----
dependencies {
    implementation 'info.picocli:picocli-spring-boot-starter:4.7.8-SNAPSHOT'
}
----
.Gradle (Kotlin)
[source,kotlin,role="secondary"]
...
[source,bash]
----
java -cp "picocli-4.7.8-SNAPSHOT.jar;myapp.jar" org.myorg.MyMainClass --option=value arg0 arg1
----
...
[source,bash]
----
alias mycommand='java -cp "/path/to/picocli-4.7.8-SNAPSHOT.jar:/path/to/myapp.jar" org.myorg.MainClass'
----
...
----
path/to/native-image -cp picocli-4.7.8-SNAPSHOT.jar --static -jar myapp.jar
----
...
Scripts should use `@Grab('info.picocli:picocli-groovy:4.7.8-SNAPSHOT')`. The old artifact id `@Grab('info.picocli:picocli:4.7.8-SNAPSHOT')` will not work,
...
----
libraryDependencies += "info.picocli" % "picocli" % "4.7.8-SNAPSHOT"
----

.Ivy
[source,role="secondary"]
----
<dependency org="info.picocli" name="picocli" rev="4.7.8-SNAPSHOT" />
----
...
----
@Grapes(
    @Grab(group='info.picocli', module='picocli', version='4.7.8-SNAPSHOT')
)
----
...
[source,role="secondary"]
----
[info.picocli/picocli "4.7.8-SNAPSHOT"]
----

.Buildr
[source,role="secondary"]
----
'info.picocli:picocli:jar:4.7.8-SNAPSHOT'
----

.JBang
[source,role="secondary"]
----
//DEPS info.picocli:picocli:4.7.8-SNAPSHOT
----

=== Source

By using picocli in source form, you can avoid having an external dependency on picocli.
Picocli has only one source file: link:https://github.com/remkop/picocli/blob/v4.7.8-SNAPSHOT/src/main/java/picocli/CommandLine.java[CommandLine.java].
